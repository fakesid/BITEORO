    ...
    <div className="p-4 sm:p-6 lg:p-8 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        ...
        <button
          ...
          className="btn-primary btn-lg shadow-md hover:shadow-lg w-full sm:w-auto justify-center"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="xl:col-span-1 card flex flex-col min-h-[320px] xl:min-h-[400px] xl:max-h-[calc(100dvh-220px)]">
      ...
      {showOrderForm && (
        ...
        >
          <div
            className="bg-surface rounded-t-[1.75rem] sm:rounded-2xl shadow-modal w-full h-[92dvh] sm:h-auto sm:max-h-[90dvh] max-w-5xl mx-0 sm:mx-4 relative animate-scale-in overflow-hidden"
